...
\begin{itemize}
    \item \textbf{Expressiveness vs simplicity.} \kl{VIP} makes a particular
        set of choices about its representation of pointers and integers, and
        relatedly about the idioms it supports. I will explain it, and
        alternatives which are simpler and more expressive. In particular,
        I will explain important and subtle complexities around round-trip
    ...
    \item \textbf{Implementation in \kl{CN}.} I will explain how I incrementally
        ...
        so I had to be careful in adding support for \kl{VIP}, and
        incrementalise large changes to code and tests.
