...
\begin{itemize}
    ...
    \item \textbf{Restrict the ability to perform round-trip casts to new C
        ...
        makes the user-visible memory object model more complex.\sidenote{For
            ...
            needs casts between them.}\label{sn:optin-typedef}
...
unlike \cninline{Block}, \cninline{Owned} and user-defined predicates
...
% \cninline{Block} for uninitialised memory (write-only) and \cninline{Owned} for
