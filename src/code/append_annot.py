...
if (xs == NULL) then
  ...
  # $\{ l_1 = v \Colon{} l_1' \wedge{} xs \mapsto v \ast{} (\mathsf{xs} + 1) \mapsto{} \mathsf{xs'} \ast{} \mathrm{list}(\mathsf{xs'}, l_1')  \ast{} \mathrm{list}(\mathsf{ys}, l_2) \}$
  new_tail = append(xs->tail, ys)
  # $\{ l_1 = v \Colon{} l_1' \wedge{} xs \mapsto{} v \ast{} (xs + 1) \mapsto{} \mathsf{xs'} \ast{}  \mathrm{list}(\mathsf{new\_tail}, l_1' @ l_2) \}$
  return xs
