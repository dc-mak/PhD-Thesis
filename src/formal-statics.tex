...
using \kl{ResCore}, due to the it not being a first-order functional with
...
structs or arrays. Notably, in \kl{MiniC} includes taking the address of
...
surface syntax of \kl{CN}, shown in \cref{fig:minic-grammar}. It includes the
