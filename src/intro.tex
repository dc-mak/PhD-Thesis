...
alias assumptions at play here. It guess that \cinline{ADDRESS_PFI_1PG} is
...
It is precisely this fact which \cninline{push_lemma} represents: if one has
...
\kl{CN} current does not support export and proofs of lemmas which mention
