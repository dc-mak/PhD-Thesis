...
\\[-1\baselineskip]
\cndrule{%
    \cnpremise{ [[ ret eq sigma yp : loc . term /\ exists y : to_base ( ct ) . ret' ]] }%
    \cnpremise{ [[ ret' eq ( yp |- Uninit - ct -> y ) *o I]] }%
}{%
...
\cndrule{
    ...
    \cnpremise{ [[ ret eq sigma _ : unit . ( inj pval0 |- Init - ct -> inj pval1 ) *o I ]] }%
}{%
...
\cndrule{%
    ...
    \cnpremise{ [[ a eq xp : loc , </ xi : base_typei // i  /> , y : base_type |-> res inEnv Globals ]] }%
...
\cndrule{%
    ...
    \cnpremise{ [[ smt ( N => ( term = inj pval0 ) ) ]] }%
    \cnpremise{ [[ ret eq sigma y : to_base ( ct ) . y = inj pval1 /\ ( inj pval0 |- Init - ct -> inj pval1 ) *o I ]] }%
}{%
