...
\section{Failed update to support bit vectors}
...
\chapter{Usability for C verification tools: reality versus expectations}

\margintoc{}

In this penultimate chapter, I will discuss the reality and expectations of how
usable a verification tool for C \emph{can} be at this stage. I will start with
my brief and informal comparison between \kl{CN} and similar tools, based on my
...
\kl{CN}. Lastly, based on my experience of having worked on programming
language tooling both in industry and in academia, I will discuss what I
believe are achievable standards of usability for \kl{CN}, with an emphasis on
how new projects can avoid several pitfalls.
...
\subsection{Early allocator in Frama-C}

\subsection{Industry feedback}
...
\subsection{Calling conventions and specifications}

\subsection{Accurate source location}
...
\subsection{Examples and over-fitting}
...
\begin{itemize}
    ...
    \item Don't use debug output \textemdash{} force yourself to structure output.
    \item Use exceptions with discipline.
\end{itemize}
