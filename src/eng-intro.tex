...
verification strategy, to upstream such code would require the
...
\paragraph{Explicit ghost parameters and arguments are necessary
(completed).}\sidenote{Implemented by Dimitrios Economou.} Changing the
