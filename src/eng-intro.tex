...
filter and carve out parts of a large C source tree, whilst preserving all
comments, including \kl{CN} annotations.
...
\paragraph{Explicit ghost parameters and arguments are necessary (completed).} Changing the
