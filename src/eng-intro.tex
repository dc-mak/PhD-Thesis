...
\begin{tikzpicture}[shorten >=1pt,node distance=2.5cm,on grid,>={Stealth[round]}]
  ...
  (L_start) edge [bend left=10]                  node [right]                        {$//-$}           (IL)
  (L_start) edge [bend left=10]                  node [left]                         {$-$}             (KL)
  (L_start) edge [color=darkgreen,bend right=10] node [below left]                   {$//$}            (CL)
  (L_start) edge [color=darkgreen]               node [left]                         {$/*$}            (KBc)
  (L_start) edge [color=blue]                    node [left]                         {$"$}             (KS)
  (IL)      edge [bend left=10]                  node [left]                         {$\backslash{}n$} (L_start)
  (IL)      edge [bend left=10]                  node [below]                        {$/*$}            (IBc)
  (IL)      edge [color=darkgreen]               node [below]                        {$//$}            (CL)
  (IL)      edge [loop below]                    node [below]                        {$-$}             ( )
  (IBc)     edge [loop above]                    node [left]                         {$\mathrm{del}(//-)$} (  )
  (IBc)     edge [bend left=10]                  node [above]                        {$*/$}                (IL)
  (CL)      edge [loop below,color=darkgreen]    node [below]                        {$-$}                 ( )
  (CL)      edge [bend right=10]                 node [right]                        {$\backslash{}n$}     (L_start)
  (EL)      edge [color=darkgreen]               node [right]                        {$//$}                (CL)
  (EL)      edge                                 node [above]                        {$\backslash{}n$}     (L_start)
  (EL)      edge [loop right]                    node                                {$WS$}                (  )
  (EL)      edge [color=darkgreen]               node [left]                         {$/*$}                (KBc)
  (KBc)     edge [loop right,color=darkgreen]    node                                {$-$}                 ( )
  (KBc)     edge [bend right=10]                 node [above]                        {$*/$}                (KL)
  (KL)      edge [loop above]                    node                                {$-$}                 ( )
  (KL)      edge [bend right=10,color=darkgreen] node [below]                        {$/*$}                (KBc)
  (KL)      edge [color=blue,bend left=10]       node                                {$"$}                   (KS)
  (KL)      edge [bend left=10]                  node [right]                        {$\backslash{}n$}                   (L_start)
  (KS)      edge [bend left=10]                  node                                {$"$}                 (KL)
