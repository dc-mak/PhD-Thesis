...
\kl{CN} can diverge on certain inputs. Below is a small example to illustrate
the problem, and later, a solution.

\cfile[lastline=21]{code/diverge.c}
...
\cfile[firstline=23]{code/diverge.c}
