...
\begin{itemize}
    \item \textbf{Perform a `mem2reg' pass on \kl{Core}.} Representing stack
        ...
        solver.\sidenote{Implemented in \href{https://github.com/rems-project/cerberus/pull/1003}{Cerberus\#1003}.
            Preliminary experiments show improvement but not by a large amount,
            perhaps due to pre-existing, syntactic fast path in the resource
            context lookup code. It remains useful usability.}
