...
% cleveref's automatic \appendix detection relies on hyperref's \H@refstepcounter,
% which recent hyperref releases no longer call, so \cref/\Cref on chapters after
% \appendix silently fall back to "Chapter" instead of "Appendix". Force it manually.
