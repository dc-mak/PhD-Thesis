...
\includeonly{header,intro,formal-intro,formal-kernel,formal-statics,formal-discussion,mem-model-intro,mem-model-cn,eng-intro,eng-usable}
%\includeonly{eng-intro,eng-usable}
