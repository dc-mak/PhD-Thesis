...
\includeonly{header,intro.gen,formal-intro,formal-kernel.gen,formal-statics.gen,formal-discussion,mem-model-intro,mem-model-cn,eng-intro,eng-usable,conclusion}
%\includeonly{intro.gen,formal-kernel.gen,formal-statics.gen,formal-discussion}
