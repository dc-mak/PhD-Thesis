...
\begin{supertabular}{@{}p{0.15\textwidth}@{}l@{\ \ }c@{\ \ }ll@{}l}#1\end{supertabular}}
\renewcommand{\cnrulehead}[3]{\multirow[c]{2}{*}[1.5ex]{\begin{mathparcomma}#1\end{mathparcomma}} & & ${\Colon}{=}$ & \multicolumn{3}{l}{#3}}
