...
\includeonly{header,intro,formal-intro,formal-kernel,_gen/formal-statics,formal-discussion,mem-model-intro,mem-model-cn,eng-intro,eng-usable,conclusion}
