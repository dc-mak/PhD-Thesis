...
\includeonly{header,intro.gen,formal-intro,formal-kernel.gen,formal-statics.gen,formal-discussion.gen,mem-model-intro,mem-model-cn.gen,eng-intro,eng-usable,conclusion}
%\includeonly{mem-model-cn.gen}
