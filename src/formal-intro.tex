...
Aiming to be a type systems means we want to minimise obvious annotations and
...
later in \nameref{sec:weak-seq}. As per \sidetextcite{memarian2022cerberus},
...
language. This becomes problemsome when attempting to relate failures in SMT
...
\cref{fig:call-incr}, where \kl{CN} deduces
...
inference is undecidable~\sidecite{turing1936computable,church1936unsolvable}.
...
require backtracking and thus exponential); in~\nameref{sec:elaboration}, I
...
\begin{itemize}
    ...
    \item $\cnnt{iargs}$ are logical/SMT arguments.
\end{itemize}
