...
\begin{marginfigure}
  ...
  part of a linear language. A declarative system is easier to describe and
  ...
  guessed ``ahead of time''. In contrast, an algorithmic system changes and
  chains the contexts across premises, which is easy to implement as mutating
  state, but requires a notion of ``context difference'' to relate to the
  declarative version.}\label{fig:decl-alg}
\end{marginfigure}
