...
\begin{figure*}[tp]
    ...
    \cngrammarcompressed{0.5\textwidth}{%
        \cnname{}\cninterrule{}
        \cncpat{}\cninterrule{}
...
\begin{figure*}[tp]
    ...
    \grammartabularSTY{%
        \cncore{}\cnafterlastrule{}
    }
    \end{minipage}
    \begin{minipage}{0.7\textwidth}%
    \begingroup%
    \renewcommand{\cnprodline}[6]{& & $#1$ & $#2$ & $#3$ & $#5$ &}
    \cngrammarcompressed{0.8\textwidth}{%
...
\emph{linearly}~\sidecite{girard1987linear} in \kl{CN}.\sidenote{TODO Should I
show and explain the structural sequent calculus rules?}
...
is large and challenging problem in its own right.} This is a tall order,
