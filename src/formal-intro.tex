...
Existing program logic frameworks for C such as Verifiable
C~\sidecite{appelSF5} and RefinedC~\sidecite{sammler2021refinedc} build a logic
logic directly above a language which is simplified with respect to the
\kl{ISO}; they attempt to retain as many C features (control flow, variable
scoping, aliasing, loose evaluation order, pointer manipulation rules) as
feasible.
...
new contribution adapting and combining those ideas. In this chapter, I set out
...
\begin{itemize}
    ...
    \item Because it will be used by kernel programmers, we want a story that is
        ...
        Nor are they amenable to change their development or company's
...
check $e$ if you can can prove $t$ and check $e'$ if you can prove $\neg\;t$.
